const FAQ = [
  ...
  { keywords: ['what does the president do', 'president role', 'president function', 'who is the head of asf'],
    answer: 'The President is the head of the entire ASF Uniben/UBTH fellowship -- not just the EXCO chairman, but the overall leader. They direct meetings, lead and coordinate all fellowship activities, present the annual budget, convene meetings through the GS, and represent the fellowship within and outside campus.' },
  ...
  // ---------- Newer site features ----------
  { keywords: ['attendance', 'check-in', 'mark present', 'attendance tracking'],
    answer: 'The GS/AGS track attendance for Wednesday and Friday services, Sunday Prayer, and Special Saturdays through the site. If you\'re a ministry group leader or EXCO member, you can see your own group\'s attendance in "My Group" or the Dashboard.' },
  { keywords: ['leader role', 'what can leaders do', 'my group', 'i am a leader'],
    answer: 'Leaders (ministry group leaders, Hall Reps, EXCO) get a read-only "My Group" and "Dashboard" view of their own group\'s members and attendance stats. Leaders can\'t edit member records or mark attendance -- that stays with the GS/AGS.' },
  { keywords: ['dashboard'],
    answer: 'Leaders and admins have a Dashboard showing Total Members, Attendance Today, Inactive Members, and a Top 5 Inactive list -- just numbers and names, no charts.' },
  { keywords: ['follow up', 'follow-up', 'inactive member', 'who follows up'],
    answer: 'When a member\'s attendance drops, an admin can assign a leader to follow up with them. The assigned leader sees it on the Follow-Ups page, can get a suggested WhatsApp message to send, and marks it completed once they\'ve reached out.' },
  { keywords: ['messages', 'internal message', 'who can message'],
    answer: 'Admins can message all members or a specific group; leaders can message only the group they lead. Members can\'t send messages, but can see anything sent to them or their group under "Messages".' },
  { keywords: ['dark mode', 'night mode', 'theme'],
    answer: 'Yes -- tap the moon/sun icon in the navbar to switch between light and dark mode. Your choice is remembered on your device.' },
  { keywords: ['member card', 'download my card', 'id card', 'digital card'],
    answer: 'From "My Profile", you can download a shareable ASF member card with your name, department, and ministry group -- handy for your WhatsApp status.' },
  { keywords: ['streak', 'attendance streak'],
    answer: 'If you\'ve attended recent Wednesday/Friday services in a row, your profile shows a 🔥 streak badge once you hit two in a row.' },
...
// Questions matching any of these are refused outright, before the normal FAQ
// lookup runs -- comparisons between people, insults, gossip, and other
// things likely to cause commotion or trouble rather than genuinely inform.
const FLAGGED_KEYWORDS = [
  'better than', 'worse than', 'best leader', 'worst leader', 'better leader',
  ' vs ', 'versus', 'compare leaders', 'compare the', 'rank the leaders',
  'ugliest', 'ugly', 'stupid', 'idiot', 'hate ', 'i hate',
  'dating who', 'is dating', 'girlfriend', 'boyfriend', 'crush on',
  'gossip', 'scandal', 'rumor', 'rumour', 'fight between', 'beef between',
  'affair', 'cheating on', 'sleeping with',
  'tribalism', 'tribe is better', 'politics', 'election rigging',
];

function isFlaggedQuestion(question) {
  const q = question.toLowerCase();
  return FLAGGED_KEYWORDS.some((k) => q.includes(k));
}

const FAQ_REFUSAL = "Sorry, this question can't be answered here.";
