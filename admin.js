    ...
    <tr>
      ...
      <td>
        ${m.role === 'admin'
          ...
          : `<button class="promote-btn" data-id="${m.id}" style="border:none; background:none; color:var(--oxblood); text-decoration:underline; cursor:pointer; font-size:0.85rem;">Make admin</button>`}
      </td>
    </tr>
  `).join('');
